function recoverPasswordEs (data: any) {
  return `
    <img src="${data.baseUrl}/public/img/unlock.png" alt="Unlock" style="height: 200px;margin: 3em auto 0 auto;display: flex;">
      
    <h1 style="margin-bottom: 0;text-align: center;">¿OLVIDASTE TU</h1>
    <h1 style="margin-top: 0;text-align: center;">CONTRASE&Ntilde;A?</h1>

    <p>
      <span style="display: block;margin: auto;color: #666666;font-size: 16px;text-align: center;">Hola ${data.firstName} ${data.lastName}</span>
      <span style="display: block;margin: auto;color: #666666;font-size: 16px;text-align: center;">¡Solicitaste un cambio de contrase&ntilde;a</span>
    </p>
    <p>
      <span style="display: block;margin: auto;color: #666666;font-size: 16px;text-align: center;">Si tu no hiciste la petici&oacute;n, ignora este email.</span>
      <span style="display: block;margin: auto;color: #666666;font-size: 16px;text-align: center;">De lo contrario, haz click en el bot&oacute;n para cambiar tu contrase&ntile;a:</span>
    </p>
...
module.exports = recoverPasswordEs;
